...
# SECURITY INFOING: keep the secret key used in production secret!
...
# OpenTelemetry
OTLP_EXPORTER_ENDPOINT = env("OTLP_EXPORTER_ENDPOINT")

# TTN
TTN_WEBHOOK_TOKEN = env("TTN_WEBHOOK_TOKEN")
TTN_APP_KEY = env("TTN_APP_KEY")
TTN_ADMIN_KEY = env("TTN_ADMIN_KEY")
TTN_APP_NAME = env("TTN_APP_NAME")
